...
export const UPGRADE_MESSAGE: Record<UpgradeError, string> = {
  ...
  heroLocked: 'Upgrade your Town Hall to level 3 to unlock the hero.',
  heroAtMax: 'Your hero is already at the highest level.',
  heroAtKeepCap: 'Your hero cannot go above your Town Hall level.',
  noLab: 'Build a Laboratory first.',
  troopAtMax: 'Already at the highest level.',
  troopAtLabCap: 'Upgrade the Laboratory first.',
  noSuchTroop: 'No such troop.',
  crewFull: 'You already have ten builders.',
  itemLocked: 'Upgrade your Town Hall to unlock this.',
  pouchFull: 'You cannot carry any more of those.',
  relicLocked: `Relics unlock at Town Hall ${RELIC_KEEP_LEVEL}.`,
  relicAtMax: 'That relic is already at the highest level.',
  relicNotForged: 'You have not unlocked that relic yet.',
